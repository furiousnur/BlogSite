                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#profile_with_icon_title" data-toggle="tab">
                                <i class="material-icons bg-cyan">face</i> <span style="color: #0f74a8;">Update Profile</span>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#password" data-toggle="tab">
                                <i class="material-icons bg-amber">error</i><span style="color: #0f74a8;">Change Password</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                            ...
                            <form class="form-horizontal" enctype="multipart/form-data"
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea name="about" id="about" cols="10" class="form-control">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="password">
                            <form class="form-horizontal"
                                  action="{{route('author.password.update')}}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        ...
                                        m-t-15 waves-effect">Update</button>
                                    </div>
                                </div>
                            </form>
                        </div>
