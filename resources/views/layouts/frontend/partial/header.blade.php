<header style="background: #2fb7aa;">
    <div class="container-fluid position-relative no-side-padding">

{{--        <h4><a href="#" class="logo"><strong style="color: #007aff;">Blog</strong></a></h4>--}}
        <a href="{{route('home')}}" class="logo"><img src="{{asset('assets/frontend/images/Blogging.png')}}" alt="Logo Image"></a>

        <div class="menu-nav-icon" data-nav-menu="#main-menu"><i class="ion-navicon"></i></div>

        <ul style="color: #fff;" class="main-menu visible-on-click" id="main-menu">
